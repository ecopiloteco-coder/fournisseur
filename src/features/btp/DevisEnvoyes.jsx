                        ...
                        <tbody>
                            {quotes.map(q => (
                                <tr key={q.id}>
                                    ...
                                    <td>
                                        <span className={`badge bg-${q.status === 'Accepté' ? 'success' : (q.status === 'Refusé' ? 'danger' : 'warning')} bg-opacity-10 text-${q.status === 'Accepté' ? 'success' : (q.status === 'Refusé' ? 'danger' : 'warning')} px-2 py-1 rounded-pill`}>
                                            {q.status}
                                        </span>
                                    </td>
