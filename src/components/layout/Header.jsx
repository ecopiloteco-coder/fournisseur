        ...
        <>
            <header className="app-header">
                <div className="app-header-inner">
                    <button
                        className="app-toggler btn btn-icon btn-action-gray rounded-circle ms-2"
                        type="button"
                        aria-label="app toggler"
                        onClick={onToggleSidebar}
                        style={{ width: '40px', height: '40px' }}
                    >
                        <i className="fi fi-rr-menu-burger" style={{ fontSize: '18px' }}></i>
                    </button>
                        ...
                        <div className="d-flex align-items-center gap-sm-2 gap-0 px-lg-4 px-sm-2 px-1">
                            ...
                            >
                                ...
                                {unreadMessagesCount > 0 && (
                                    <span 
                                        className="position-absolute top-0 end-0 bg-danger border border-2 border-light rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                                        style={{ width: '18px', height: '18px', fontSize: '10px', marginTop: '-5px', marginRight: '-5px' }}
                                    >
